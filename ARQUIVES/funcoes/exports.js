...
const { addBanned, unBanned, BannedExpired, cekBannedUser } = require("../../ARQUIVES/js/banned.js");
    const namoro1 = JSON.parse(fs.readFileSync("./DADOS DO YUTA/func/namoro1.json"));
const namoro2 = JSON.parse(fs.readFileSync("./DADOS DO YUTA/func/namoro2.json"));
...
// [JSON] - Funções Abaixo >>> :
const pushnames = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/users.json'));
const obrigadoEXT = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/media/nescessario.json'))
const rgtake = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/take.json'));
const sotoy = JSON.parse(fs.readFileSync('./ARQUIVES/json/sotoy.json'));
const countMessage = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/media/countmsg.json'));
const comandos = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/media/comandos.json'));
const daily = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/diario.json'));
const nescessario = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/media/nescessario.json'));
const vip = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/vip.json'));
const ban = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/banned.json'));
const muted = JSON.parse(fs.readFileSync('./DADOS DO YUTA/grupos/muted.json'))
const limitefll = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/flood.json'));
const joguinhodavelhajs = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/joguinhodavelha.json'));
const joguinhodavelhajs2 = JSON.parse(fs.readFileSync('./DADOS DO YUTA/usuarios/joguinhodavelha2.json'));
const antispam = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/media/antispam.json'));
const anotar = JSON.parse(fs.readFileSync("./DADOS DO YUTA/func/anotar.json"));
const setting = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/media/INFO_YUTA.json'));
const logoslink = JSON.parse(fs.readFileSync('./DADOS DO YUTA/INFO_YUTA/LOGOS/links_img.json'));
const Limit_CMD = JSON.parse(fs.readFileSync("./DADOS DO YUTA/func/limitarcmd.json"))
...
const { linguagem, mess, getInfo } = require('../../DADOS DO YUTA/INFO_YUTA/lib');
...
var EnvBotao = async (id, MR, yuta, text1, desc1, X) => {
if(X.split("|")[1] != "0") {
yuta.sendMessage(id, {image: {url: X.split("|")[1]}, caption: text1, mentions: [MR]})} else {yuta.sendMessage(id, {text: text1, mentions: [MR]})}}
} else {
var EnvBotao = async(id, MR, yuta, text1, desc1, X, TXT = [], vr) => {
...
yuta.sendMessage(id, buttonMessage, {quoted: vr}).catch(e => {
...
const listCommands = (targetWord) => {
      const fileContent = fs.readFileSync("yuta.js", "utf8");
